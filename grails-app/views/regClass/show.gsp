	...
	<body>
		...
		<div id="show-regClass" class="content scaffold-show" role="main">
			...
			<ol class="property-list regClass">
				...
				<g:if test="${regClassInstance?.registrationSheets}">
				<li class="fieldcontain">
					<span id="registrationSheets-label" class="property-label"><g:message code="regClass.registrationSheets.label" default="Registration Sheets" /></span>
